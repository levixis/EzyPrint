...
interface AccountOtpModalProps {
  isOpen: boolean;
  onClose: () => void;
  title: string;
...
export const AccountOtpModal: React.FC<AccountOtpModalProps> = ({
  isOpen,
  onClose,
  title,
  description,
      ...
      <div className="space-y-4">
        ...
        {!otpSent ? (
          ...
          <div className="bg-red-50 dark:bg-red-900/10 p-5 rounded-xl border border-red-100 dark:border-red-900/30 text-center animate-fade-in relative overflow-hidden">
            ...
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">A 6-digit code has been sent to your email.</p>
            ...
            <div className="flex gap-3">
              ...
              <Button 
                ...
                className="!bg-gradient-to-r !from-brand-primary !to-red-600"
              >
